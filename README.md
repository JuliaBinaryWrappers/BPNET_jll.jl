# `BPNET_jll.jl` (v0.0.2+0)

[![deps](https://juliahub.com/docs/BPNET_jll/deps.svg)](https://juliahub.com/ui/Packages/General/BPNET_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/cc7499c3c7af05711a9220eb48117b25c6226643/B/BPNET/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
The tarballs for `BPNET_jll.jl` have been built from these sources:

* git repository: https://github.com/cometscome/BPNET.git (revision: `207fd1d739b8cadcf243fc1bd7e1e8d7d28af392`)
* files in directory, relative to originating `build_tarballs.jl`: [`./bundled`](https://github.com/JuliaPackaging/Yggdrasil/tree/cc7499c3c7af05711a9220eb48117b25c6226643/B/BPNET/bundled)

## Platforms

`BPNET_jll.jl` is available for the following platforms:
...
The following JLL packages are required by `BPNET_jll.jl`:
...
* `ExecutableProduct`: `generate`
* `ExecutableProduct`: `nnASCII2bin`
* `ExecutableProduct`: `predict`
* `ExecutableProduct`: `trainbin2ASCII`
